...
/**
 * One of the things BshClassLoader does is to address a deficiency in URLClassLoader that prevents
 * us from specifying individual classes via URLs.
 */
public class BshClassLoader extends URLClassLoader {
    ...
    /**
     * This modification allows us to reload classes which are in the Java VM user classpath. We
     * search first rather than delegate to the parent classloader (or bootstrap path) first.
     *
     * <p>An exception is for BeanShell core classes which are always loaded from the same
     * classloader as the interpreter.
     */
    public Class loadClass(String name, boolean resolve) throws ClassNotFoundException {
        ...
        */
        ...
        if (c == null) throw new ClassNotFoundException("(载入类)");
     ...
     *
     * <p>Try designated loader if any Try our URLClassLoader paths if any Try base loader if any
     * Try system ???
     */
    ...
    protected Class findClass(String name) throws ClassNotFoundException {
        ...
        if (cl != null && cl != this)
            try {
                ...
                throw new ClassNotFoundException("钦定的加载器找不到类 " + e);
            }
