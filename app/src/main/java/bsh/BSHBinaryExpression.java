...
/**
 * Implement binary expressions... Note: this is too complicated... need some cleanup and
 * simplification.
 *
    ...
    public Object eval(CallStack callstack, Interpreter interpreter) throws EvalError {
        ...
        */
        if (kind == INSTANCEOF) {
            ...
            if (lhs == Primitive.NULL) return Primitive.FALSE;
            ...
            */
            if (lhs instanceof Primitive)
                if (rhs == bsh.Primitive.class) return Primitive.TRUE;
                else return Primitive.FALSE;
