...
/**
 * A specialized namespace for Blocks (e.g. the body of a "for" statement). The Block acts like a
...
class BlockNameSpace extends NameSpace {
    ...
    */
     ...
     * this set to the parent. Typed variables are naturally set locally. This is used in try/catch
     * block argument.
     */
    ...
    /**
     * We have the variable: either it was declared here with a type, giving it block local scope or
     * an untyped var was explicitly set here via setBlockVariable().
     */
     ...
     *
     * <p>Normally a 'this' reference to a BlockNameSpace (e.g. if () { } ) resolves to the parent
     * namespace (e.g. the namespace containing the "if" statement). However when code inside the
    ...
    /**
     * Get a 'this' reference is our parent's 'this' for the object closure. e.g. Normally a 'this'
